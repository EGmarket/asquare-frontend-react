            ...
            <Fragment>
                <div className="footer-back m-0 mt-5 pt-sm-1 pb-1 shadow-sm">
                    ...
                    <Container fluid={true} className="text-center m-0 pt-3 pb-1 bg-dark">
                        <Container>
                            <Row>
                                <h6 className="text-white">© Copyright 2022 by aSquare Shop, All Rights Reserved</h6>
                            </Row>
                        </Container>
                    </Container>
